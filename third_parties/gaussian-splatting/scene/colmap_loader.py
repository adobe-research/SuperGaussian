...
def read_points3D_binary(path_to_model_file, s3_client=None):
    """
    see: src/base/reconstruction.cc
...
def read_extrinsics_binary(path_to_model_file, s3_client=None):
    """
    see: src/base/reconstruction.cc
...
def read_intrinsics_binary(path_to_model_file, s3_client=None):
    """
    see: src/base/reconstruction.cc
